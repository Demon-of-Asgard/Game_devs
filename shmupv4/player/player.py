...
class Player(pygame.sprite.Sprite):
    def __init__(self, player_img, bullet_img, SCREEN_WIDTH, SCREEN_HEIGHT):
        ...
        self.bullets = 50
        self.shoot_speedx = 0
        self.shoot_speedy = -int(self.SCREEN_HEIGHT*self.SCALE_LENGTH*2.0)
        self.rot = 0
        self.rot_speed = 90
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
    ...
    def shoot(self):
        bullet = Bullet(
            self.bullet_img, int(self.rect.x+self.rect.w/2), 
            int(self.rect.top), self.shoot_speedx, self.shoot_speedy,
